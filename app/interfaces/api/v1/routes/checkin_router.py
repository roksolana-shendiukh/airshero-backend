...
from app.core.services import checkin_service, reference_service
from app.database import get_db
from app.interfaces.api.dependencies.auth import require_role
from app.interfaces.schemas.checkin_schema import (
    IssueCheckinDTO,
    CalculateBaggageRequestDTO,
    CalculateBaggageResponseDTO,
)
...
def calculate_baggage(
    ...
    return checkin_service.calculate_baggage_surcharge(db, booking_item_id, body.bag_weights)  # виправлено: bagWeights → bag_weights
