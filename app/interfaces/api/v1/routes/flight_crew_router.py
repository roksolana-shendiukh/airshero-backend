...
from app.interfaces.schemas.crew_schema import AssignCrewRequestDTO
...
def get_available_crew(
    ...
    if not airline_id:
        raise HTTPException(status_code=403, detail="airline_id not found in token")
...
def assign_crew(
    ...
    try:
        return flight_crew_service.assign_crew(
            db, operation_id, body.crew_id, airline_id
        )
