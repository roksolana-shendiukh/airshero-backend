...
from app.infrastructure.database.models.citizenship_model import Citizenship
from app.infrastructure.database.models.document_model import DocumentType
