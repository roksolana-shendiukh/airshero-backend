...
from app.schemas.booking_schema import CreateBookingDTO, BookingResponseDTO
...
def create_booking(
    ...
    try:
        ...
        background_tasks.add_task(booking_service.cancel_booking_if_not_paid, result["bookingId"])
        return result
