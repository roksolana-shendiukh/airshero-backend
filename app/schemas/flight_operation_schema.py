...
class FlightOperationCreateDTO(BaseModel):
    flight_id:                  int
    flight_operation_status_id: int
...
class FlightOperationDTO(BaseModel):
    ...
    actualArrivalDatetime:    Optional[datetime] = None
    boardingStartTime:        Optional[datetime] = None
    boardingEndTime:          Optional[datetime] = None
    baggageLoadingStartTime:  Optional[datetime] = None
    baggageLoadingEndTime:    Optional[datetime] = None